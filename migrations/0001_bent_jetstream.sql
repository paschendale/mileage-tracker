...
INSERT INTO `__new_fill_ups`("id", "vehicle_id", "created_at", "date", "odometer_km", "liters", "total_price", "fuel_type", "is_full_tank", "notes") SELECT "id", "vehicle_id", "created_at", "date", "odometer_km", "liters", "total_price", "fuel_type", "is_full_tank", "notes" FROM `fill_ups`;--> statement-breakpoint
