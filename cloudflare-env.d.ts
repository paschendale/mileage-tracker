/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 133494f6de1ecb8b9c32ce497f1f105d)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	AUTH_TOKEN: string;
	WORKER_SELF_REFERENCE: Fetcher /* mileage-tracker */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "AUTH_TOKEN">> {}
}
